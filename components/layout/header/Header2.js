                            ...
                            <div className="d-lg-flex flex-xl-nowrap flex-wrap align-items-center justify-content-lg-between">
                                <div className="d-flex align-items-center justify-content-between">
                                    <Link href="/" className="brand-logo">
                                        <img className="w-100" src="/assets/img/footer/let-arrow.png" alt="OMNIframe Logo" />
                                    </Link>
                                ...
                                <div className="d-lg-flex d-grid justify-content-center ph-clickwrap align-items-center gap-xxl-5 gap-xl-4 gap-lg-4 gap-3">
                                    <Link href="tel:+995544445221" className="d-flex align-items-center header-ph gap-2">
