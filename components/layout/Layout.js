...
export default function Layout({ headerStyle, footerStyle, breadcrumbTitle, coverImage, children }) {
    ...
    // Show Breadcrumb if there's a coverImage or breadcrumbTitle
    const shouldShowBreadcrumb = breadcrumbTitle || coverImage
    ...
    return (
        <><div id="top" />
            ...
            <main className="main">
                {shouldShowBreadcrumb && <Breadcrumb breadcrumbTitle={breadcrumbTitle} coverImage={coverImage} />}
