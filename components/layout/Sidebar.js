                ...
                <div className="sub-contact-wrapper d-grid">
                    ...
                    <ul className="common-social d-flex align-items-center gap-2 mb-xxl-10 mb-xl-9 mb-8">
                        <li data-aos="zoom-in-right" data-aos-duration={1400}>
                            <Link href="https://facebook.com/omniframe" target="_blank" rel="noopener noreferrer" className="d-center">
                        ...
                        <li data-aos="zoom-in-right" data-aos-duration={1600}>
                            <Link href="https://twitter.com/omniframe" target="_blank" rel="noopener noreferrer" className="d-center">
                        ...
                        <li data-aos="zoom-in-right" data-aos-duration={1800}>
                            <Link href="https://linkedin.com/company/omniframe" target="_blank" rel="noopener noreferrer" className="d-center">
                        ...
                        <li data-aos="zoom-in-right" data-aos-duration={1900}>
                            <Link href="https://youtube.com/@omniframe" target="_blank" rel="noopener noreferrer" className="d-center">
