...
const maintenanceTexts = {
    breadcrumb: { en: "Web Maintenance", ka: "ვებ-მხარდაჭერა" },
    mainTitle: { en: "Comprehensive Web Maintenance Services for Optimal Performance.", ka: "ვებ-მხარდაჭერის სრულყოფილი სერვისი თქვენი საიტის გამართული მუშაობისთვის." },
    ...
    paragraph1: { en: "Our web maintenance services ensure your website remains secure, fast, and up-to-date at all times. We provide ongoing support, security updates, performance optimization, and content management to keep your online presence running smoothly and efficiently.", ka: "ვებ-მხარდაჭერის სერვისი უზრუნველყოფს თქვენი ვებსაიტის უსაფრთხოებას, სისწრაფესა და მუდმივ განახლებას. ჩვენ გთავაზობთ უწყვეტ ტექნიკურ მხარდაჭერას, უსაფრთხოების სისტემების განახლებას, წარმადობის ოპტიმიზაციასა და კონტენტის მართვას თქვენი ბიზნესის შეუფერხებელი მუშაობისთვის." },
    paragraph2: { en: "We understand that a website requires continuous attention to maintain its performance and security. Our maintenance team monitors your site 24/7, performs regular backups, updates software, and addresses any issues promptly to minimize downtime and ensure optimal user experience.", ka: "ჩვენ ვიცით, რომ ვებსაიტს მუდმივი ყურადღება სჭირდება წარმადობისა და უსაფრთხოების შესანარჩუნებლად. ჩვენი გუნდი ახორციელებს საიტის 24/7 მონიტორინგს, რეგულარულ რეზერვირებას (Backup), პროგრამულ განახლებებსა და ნებისმიერი ხარვეზის ოპერატიულ აღმოფხვრას, რაც მინიმუმამდე ამცირებს შეფერხებებს." },
    benefitsTitle: { en: "Benefits With Our Web Maintenance", ka: "ვებ-მხარდაჭერის უპირატესობები" },
    benefit1: { en: "24/7 website monitoring & support", ka: "საიტის 24/7 მონიტორინგი და მხარდაჭერა" },
    benefit2: { en: "Security updates & vulnerability fixes", ka: "უსაფრთხოების სისტემების განახლება და ხარვეზების აღმოფხვრა" },
    benefit3: { en: "Performance optimization & speed improvements", ka: "წარმადობის ოპტიმიზაცია და სისწრაფის გაუმჯობესება" },
    benefit4: { en: "Regular backups & disaster recovery", ka: "რეგულარული რეზერვირება (Backup) და მონაცემთა აღდგენა" },
    benefit5: { en: "Content updates & management", ka: "კონტენტის განახლება და მართვა" },
    benefit6: { en: "SEO maintenance & improvements", ka: "SEO ოპტიმიზაცია და მხარდაჭერა" },
    uptime: { en: "Uptime", ka: "Uptime (უწყვეტი მუშაობა)" },
    responseTime: { en: "Response Time", ka: "რეაგირების დრო" },
