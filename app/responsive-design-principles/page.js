...
const responsiveTexts = {
    breadcrumb: {
        en: "Responsive Design Principles: Complete Guide",
        ka: "Responsive დიზაინის პრინციპები:<br />სრული გზამკვლევი",
    },
    writtenBy: { en: "Written by:", ka: "ავტორი:" },
    omniframeTeam: { en: "OMNIframe Team", ka: "OMNIframe გუნდი" },
    mainTitle: {
        en: "Responsive Design Principles: Building Websites for All Devices",
        ka: "Responsive დიზაინის პრინციპები: ვებსაიტები ყველა მოწყობილობისთვის",
    },
    paragraph1: {
        en: "In today's multi-device world, responsive design is no longer optional—it's essential. With users accessing websites from smartphones, tablets, laptops, and desktop computers, creating a seamless experience across all screen sizes has become a fundamental requirement for modern web development.",
        ka: "დღევანდელ მრავალმოწყობილობით სამყაროში responsive დიზაინი არჩევანი აღარ არის — ეს აუცილებლობაა. რადგან მომხმარებლები ვებსაიტებს სმარტფონებიდან, პლანშეტებიდან, ლეპტოპებიდან და დესკტოპებიდან აკვირდებიან, ყველა ეკრანის ზომაზე თანმიმდევრული გამოცდილების შექმნა თანამედროვე ვებ განვითარების საბაზისო მოთხოვნა გახდა.",
    },
    paragraph2: {
        en: "This comprehensive guide explores the core principles of responsive design, from mobile-first approaches to flexible layouts and adaptive content. Whether you're a beginner or an experienced developer, these principles will help you create websites that look and function perfectly on any device.",
        ka: "ეს ყოვლისმომცველი გზამკვლევი განიხილავს responsive დიზაინის ძირითად პრინციპებს — mobile-first მიდგომებიდან მოქნილ ლეიაუთებამდე და ადაპტურ კონტენტამდე. იქნებით დამწყები თუ გამოცდილ დეველოპერი, ეს პრინციპები დაგეხმარებათ შექმნათ ვებსაიტები, რომლებიც ნებისმიერ მოწყობილობაზე კარგად გამოიყურება და იფუნქციონირებს.",
    },
    sectionTitle: {
        en: "1. Mobile-First Design Approach",
        ka: "1. Mobile-first დიზაინის მიდგომა",
    },
    sectionParagraph: {
        en: "The mobile-first approach is a fundamental principle of responsive design that involves designing for mobile devices first, then progressively enhancing the design for larger screens. This approach ensures that your website provides an optimal experience on the smallest devices while maintaining functionality on larger screens.",
        ka: "Mobile-first მიდგომა responsive დიზაინის ერთ-ერთი ძირითადი პრინციპია: ჯერ ვქმნით დიზაინს მობილური მოწყობილობებისთვის, შემდეგ კი ეტაპობრივად ვაფართოებთ მას დიდი ეკრანებისთვის. ასეთი მიდგომა უზრუნველყოფს, რომ თქვენი ვებსაიტი მცირე ეკრანებზე იყოს საუკეთესო გამოცდილების მქონე და ამასთან, სრულფასოვნად მუშაობდეს დიდ ეკრანებზე.",
    },
    advantage1: {
        en: "Start with mobile layout and functionality",
        ka: "დაიწყეთ მობილური ლეიაუთითა და ფუნქციონალით",
    },
    advantage2: {
        en: "Use progressive enhancement for larger screens",
        ka: "გამოიყენეთ progressive enhancement დიდი ეკრანებისთვის",
    },
    advantage3: {
        en: "Prioritize content and navigation for mobile users",
        ka: "მობილური მომხმარებლებისთვის დააპრიორიტეტეთ კონტენტი და ნავიგაცია",
    },
    advantage4: {
        en: "Ensure touch-friendly interface elements",
        ka: "უზრუნველყოთ touch-მეგობრული ინტერფეისის ელემენტები",
    },
    advantage5: {
        en: "Optimize images and media for mobile performance",
        ka: "ოპტიმიზაცია გაუკეთეთ სურათებსა და მედიას მობილური წარმადობისთვის",
    },
    quote: {
        en: "Responsive design is not just about making websites work on mobile devices; it's about creating an optimal user experience across all screen sizes and devices.",
        ka: "Responsive დიზაინი მხოლოდ იმაზე არ არის, რომ საიტი მობილურზე იმუშაოს — ის არის ოპტიმალური მომხმარებლის გამოცდილების შექმნაზე ყველანაირ ეკრანზე და მოწყობილობაზე.",
    },
    conclusion: {
        en: "By following these responsive design principles, you can create websites that not only adapt to different screen sizes but also provide an excellent user experience regardless of the device being used.",
        ka: "ამ responsive დიზაინის პრინციპების დაცვით, შეგიძლიათ შექმნათ ვებსაიტები, რომლებიც არა მხოლოდ ადაპტირდებიან სხვადასხვა ეკრანის ზომაზე, არამედ უზრუნველყოფენ შესანიშნავ მომხმარებლის გამოცდილებას, მიუხედავად იმისა, თუ რომელი მოწყობილობიდან ეძახიან მათ.",
    },
    ...
    nextPost: {
        en: "React vs Vue 2024",
        ka: "React vs Vue 2024",
    },
...
export default function ResponsiveDesignPrinciples() {
                            ...
                            <div className="col-12 col-lg-8">
                                <div className="blog-post-details mb-xxl-10 mb-xl-8 mb-lg-7 mb-6">
                                    <div className="single-blog-post">
                                        <div className="post-featured-thumb w-100 mb-xxl-30 mb-xl-6 mb-5" data-aos="zoom-in" data-aos-duration={1400}>
                                            <img src="/assets/img/blog/featured/responsive-design-principles-guide.jpg" alt="Responsive Design Principles Guide" className="w-100" />
                                        </div>
                                        <div className="post-content">
                                            <div className="post-marry d-flex align-items-center gap-xxl-8 gap-xl-6 gap-4 gap-3 mb-xxl-5 mb-xl-4 mb-lg-3 mb-3" data-aos="fade-left" data-aos-duration={1500}>
                                                <span>
                                                    {t('writtenBy', responsiveTexts.writtenBy)}{" "}
                                                    <span className="tag-clr">
                                                        {t('omniframeTeam', responsiveTexts.omniframeTeam)}
                                                    </span>
                                                </span>
                                            ...
                                            <div className="row g-xl-4 g-3 mb-xxl-10 mb-xl-7 mb-lg-6 mb-4">
                                                <div className="col-lg-6 col-md-6 col-sm-6" data-aos="zoom-in" data-aos-duration={1500}>
                                                    <div className="details-thumb-b1 w-100">
                                                        <img src="/assets/img/blog/content/mobile-first-design-approach.jpg" alt="Mobile First Design Approach" className="w-100" />
                                                    </div>
                                                </div>
                                                <div className="col-lg-6 col-md-6 col-sm-6" data-aos="zoom-in" data-aos-duration={1600}>
                                                    <div className="details-thumb-b1 w-100">
                                                        <img src="/assets/img/blog/content/responsive-breakpoints-layout.jpg" alt="Responsive Breakpoints Layout" className="w-100" />
                                                    </div>
                                                </div>
                                            </div>
                                            <p className="pra-clr mb-xxl-8 mb-xl-6 mb-lg-5 mb-4" data-aos="zoom-in-left" data-aos-duration={1400}>
                                                {t('sectionParagraph', responsiveTexts.sectionParagraph)}
                                            </p>
                                            <ul className="blod-dlist d-grid gap-xl-2 gap-2 mb-xxl-8 mb-xl-6 mb-lg-5 mb-4">
                                                <li>
                                                    {t('advantage1', responsiveTexts.advantage1)}
                                                </li>
                                                <li>
                                                    {t('advantage2', responsiveTexts.advantage2)}
                                                </li>
                                                <li>
                                                    {t('advantage3', responsiveTexts.advantage3)}
                                                </li>
                                                <li>
                                                    {t('advantage4', responsiveTexts.advantage4)}
                                                </li>
                                                <li>
                                                    {t('advantage5', responsiveTexts.advantage5)}
                                                </li>
                                            </ul>
                                            <div className="hilight-text py-xxl-12 py-xl-9 py-lg-7 py-sm-6 py-4 px-xxl-20 px-xl-15 px-lg-10 px-sm-8 px-4 mb-xxl-8 mb-xl-6 mb-lg-5 mb-4" data-aos="fade-left" data-aos-duration={1400}>
                                                <p>
                                                    {t('quote', responsiveTexts.quote)}
                                                </p>
                                            </div>
                                            <p className="pra-clr" data-aos="zoom-in-left" data-aos-duration={1400}>
                                                {t('conclusion', responsiveTexts.conclusion)}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="tag-share d-sm-flex d-grid align-items-center justify-content-sm-between justify-content-center mb-xxl-8 mb-xl-7 mb-5 gap-3" data-aos="zoom-in" data-aos-duration={1400}>
                                    <div className="tag d-flex justify-content-sm-start justify-content-center align-items-center gap-xxl-4 gap-3">
                                        {t('tagsLabel', responsiveTexts.tagsLabel)}
                                ...
                                <div className="nextprevius-text d-flex align-items-center justify-content-between mb-xxl-6 mb-xl-5 mb-4">
                                    ...
                                    >
                                        ...
                                        <span className="dd-clr">
                                            {t('prevPost', responsiveTexts.prevPost)}
                                        </span>
                                    </Link>
                                    <Link
                                        ...
                                        data-aos-duration={1500}
                                    >
                                        {t('nextPost', responsiveTexts.nextPost)}
                                    </Link>
                                </div>
                            </div>
                                ...
                                <div className="blog-right-bar mt-lg-0 mt-4">
                                    <div className="box mb-xxl-10 mb-xl-8 mb-7">
                                        <div className="wid-title" data-aos="fade-left" data-aos-duration={1600}>
                                            <h6>{t('search', responsiveTexts.search)}</h6>
                                        </div>
                                        <div className="search-widget" data-aos="zoom-in" data-aos-duration={1400}>
                                            <form action="#">
                                                <input
                                                    ...
                                                    placeholder={t(
                                                        'searchPlaceholder',
                                                        responsiveTexts.searchPlaceholder
                                                    )}
                                                />
                                    ...
                                    <div className="box mb-xxl-10 mb-xl-8 mb-7">
                                        <div className="wid-title" data-aos="fade-left" data-aos-duration={1600}>
                                            <h6>{t('categories', responsiveTexts.categories)}</h6>
                                        </div>
                                            ...
                                            <ul className="d-grid gap-xxl-3 gap-3">
                                                <li>
                                                    <Link href="/blog-list">
                                                        {t(
                                                            'frontendDevelopment',
                                                            responsiveTexts.frontendDevelopment
                                                        )}{" "}
                                                        <span>(4)</span>
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/blog-list">
                                                        {t(
                                                            'backendDevelopment',
                                                            responsiveTexts.backendDevelopment
                                                        )}{" "}
                                                        <span>(3)</span>
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/blog-list">
                                                        {t('webDevelopment', responsiveTexts.webDevelopment)}{" "}
                                                        <span>(5)</span>
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/blog-list">
                                                        {t('ecommerce', responsiveTexts.ecommerce)}{" "}
                                                        <span>(2)</span>
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/blog-list">
                                                        {t('performance', responsiveTexts.performance)}{" "}
                                                        <span>(3)</span>
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/blog-list">
                                                        {t('bestPractices', responsiveTexts.bestPractices)}{" "}
                                                        <span>(4)</span>
                                                    </Link>
                                                </li>
                                            </ul>
                                    ...
                                    <div className="box mb-xxl-10 mb-xl-8 mb-7">
                                        <div className="wid-title" data-aos="fade-left" data-aos-duration={1600}>
                                            <h6>{t('recentPosts', responsiveTexts.recentPosts)}</h6>
                                        </div>
                                            ...
                                            <div className="recent-items d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2" data-aos="fade-down" data-aos-duration={1200}>
                                                ...
                                                <div className="recent-content">
                                                    ...
                                                    <Link href="/react-vs-vue-2024">
                                                        {t('recentPost1', responsiveTexts.recentPost1)}
                                                    </Link>
                                                </div>
                                            </div>
                                            <div className="recent-items d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2" data-aos="fade-down" data-aos-duration={1400}>
                                                ...
                                                <div className="recent-content">
                                                    ...
                                                    <Link href="/nextjs-performance-tips">
                                                        {t('recentPost2', responsiveTexts.recentPost2)}
                                                    </Link>
                                                </div>
                                            </div>
                                            <div className="recent-items d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2" data-aos="fade-down" data-aos-duration={1600}>
                                                ...
                                                <div className="recent-content">
                                                    ...
                                                    <Link href="/modern-css-techniques">
                                                        {t('recentPost3', responsiveTexts.recentPost3)}
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="box">
                                        <div className="wid-title" data-aos="fade-left" data-aos-duration={1600}>
                                            <h6>{t('tagTitle', responsiveTexts.tagTitle)}</h6>
                                        </div>
                                        <div className="tagwrap d-flex flex-wrap gap-xl-6 gap-lg-4 gap-md-3 gap-2">
                                            ...
                                            <Link href="/blog-list">Mobile-First</Link>
                                            <Link href="/blog-list">CSS Grid</Link>
                                            <Link href="/blog-list">Flexbox</Link>
                                            <Link href="/blog-list">Media Queries</Link>
                                            <Link href="/blog-list">User Experience</Link>
                                            <Link href="/blog-list">Cross-Device</Link>
